...
namespace ecommerce.webui.Controllers
{
    public class CartController:Controller
    {
        ...
        public CartController(UserManager<User> userManager, ICartRepository cartRepository)
        {
        ...
        private Payment PaymentProcess(OrderModel orderModel){
            ...
            options.ApiKey = "sandbox-4oDjI2IvI3fSArc6VprMhPhweXET0Phd";
            options.SecretKey = "9lijMeKws382fxtYKi1borPLyPVMNGmv";
