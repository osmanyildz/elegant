        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SizeTypes_ParentCategories_ParentCategoryId",
                        column: x => x.ParentCategoryId,
                        principalTable: "ParentCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GenderCategories", x => new { x.GenderId, x.CategoryId });
                    table.ForeignKey(
                        name: "FK_GenderCategories_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GenderCategories_Genders_GenderId",
                        column: x => x.GenderId,
                        principalTable: "Genders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SizeTypeId = table.Column<int>(type: "INTEGER", nullable: false),
                    ProductId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductSizeTypes", x => new { x.ProductId, x.SizeTypeId });
                    table.ForeignKey(
                        name: "FK_ProductSizeTypes_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductSizeTypes_SizeTypes_SizeTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GenderCategories_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSizeTypes_SizeTypeId",
                table: "ProductSizeTypes",
                column: "SizeTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_SizeTypes_ParentCategoryId",
                table: "SizeTypes",
                column: "ParentCategoryId");
        }
